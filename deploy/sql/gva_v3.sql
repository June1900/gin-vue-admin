...
-- ----------------------------
BEGIN;
INSERT INTO "sys_authority_btns" ("authority_id", "sys_menu_id", "sys_base_menu_btn_id", "menu_version") VALUES (888, 9, 8, 'v2'), (888, 10, 7, 'v2');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO "sys_authority_menus_v2" ("sys_base_menu_id", "sys_authority_authority_id") VALUES ('14', '888'), ('15', '888'), ('16', '888'), ('8', '888'), ('11', '888'), ('9', '888'), ('10', '888');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO "sys_base_menu_btns" ("id", "created_at", "updated_at", "deleted_at", "name", "desc", "sys_base_menu_id", "menu_version") VALUES (1, '2026-07-24 14:41:49.933001+00', '2026-07-24 14:41:49.933001+00', NULL, '请问请问发的', '1111', 16, 'v1'), (2, '2026-07-24 14:43:00.111665+00', '2026-07-24 14:43:00.111665+00', NULL, 'asdsadsad', '打死打死打', 18, 'v1'), (3, '2026-07-24 14:43:00.111665+00', '2026-07-24 14:43:00.111665+00', NULL, 'ssss', '111', 18, 'v1'), (7, '2026-08-01 08:57:32.873874+00', '2026-08-01 08:57:32.873874+00', NULL, '紧急呼叫好借好还', '近近景近景', 10, 'v2'), (8, '2026-08-01 10:36:02.894693+00', '2026-08-01 10:36:02.894693+00', NULL, 'ADDD', '11', 9, 'v2');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO "sys_base_menu_parameters" ("id", "created_at", "updated_at", "deleted_at", "sys_base_menu_id", "type", "key", "value", "menu_version") VALUES (2, '2026-08-01 08:57:32.87288+00', '2026-08-01 08:57:32.87288+00', NULL, 10, 'query', '呃呃呃呃', 'hhh', 'v2'), (1, '2026-08-01 08:48:20.680003+00', '2026-08-01 08:48:20.680003+00', NULL, 9, 'query', 'back', '11', 'v2');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO "sys_base_menus_v2" ("id", "created_at", "updated_at", "deleted_at", "menu_level", "parent_id", "path", "name", "hidden", "component", "sort", "active_name", "keep_alive", "default_menu", "title", "icon", "close_tab", "transition_type", "menu_type", "layout") VALUES (11, '2026-08-01 08:30:38.975303+00', '2026-08-01 08:30:38.975303+00', NULL, 0, 8, '/system-tools/system', 'system-tools_system', 'f', 'view.system-tools_system', 0, '', 'f', 'f', 'route.system-tools_system', 'ri:album-fill', 'f', '', 'menu', 'layout.base'), (8, '2026-08-01 02:35:07.336232+00', '2026-08-01 08:47:37.672162+00', NULL, 0, 0, '/system-tools', 'system-tools', 'f', 'system-tools', 1, '', 'f', 'f', 'route.system-tools', 'ri:add-box-fill', 'f', '', 'directory', 'layout.base'), (10, '2026-08-01 07:53:45.059519+00', '2026-08-01 08:57:32.875648+00', NULL, 0, 8, '/system-tools/version', 'system-tools_version', 'f', 'view.system-tools_version', 4, '', 'f', 'f', 'route.system-tools_version', 'ri:bank-line', 'f', '', 'menu', 'layout.base'), (12, '2026-08-01 09:13:09.991449+00', '2026-08-01 09:13:19.865123+00', '2026-08-01 09:25:20.481316+00', 0, 0, '/ops-monitor', 'ops-monitor', 'f', 'ops-monitor', 2, '', 'f', 'f', 'route.ops-monitor', 'ri:align-center', 'f', '', 'directory', 'layout.base'), (13, '2026-08-01 09:25:40.606138+00', '2026-08-01 09:25:49.379137+00', '2026-08-01 09:25:58.906879+00', 0, 0, '/system', 'system', 'f', 'system', 0, '', 'f', 'f', 'route.system', 'ri:alarm-fill', 'f', '', 'directory', 'layout.base'), (15, '2026-08-01 09:26:42.255859+00', '2026-08-01 09:26:42.255859+00', NULL, 0, 14, '/system/user', 'system_user', 'f', 'view.system_user', 0, '', 'f', 'f', 'route.system_user', 'ri:user-add-fill', 'f', '', 'menu', 'layout.base'), (16, '2026-08-01 09:27:16.312177+00', '2026-08-01 09:27:16.312177+00', NULL, 0, 14, '/system/department', 'system_department', 'f', 'view.system_department', 1, '', 'f', 'f', 'route.system_department', 'ri:anchor-fill', 'f', '', 'menu', 'layout.base'), (14, '2026-08-01 09:26:19.251509+00', '2026-08-01 09:49:10.494042+00', NULL, 0, 0, '/system', 'system', 'f', 'system', 0, '', 'f', 'f', 'route.system', 'ri:chat-ai-3-fill', 'f', '', 'directory', 'layout.base'), (9, '2026-08-01 07:40:27.730905+00', '2026-08-01 10:36:02.897607+00', NULL, 0, 8, '/system-tools/api-token', 'system-tools_api-token', 'f', 'view.system-tools_api-token', 3, '', 'f', 'f', 'route.system-tools_api-token', 'ri:account-box-2-line', 'f', '', 'menu', 'layout.base');
COMMIT;
...
SELECT setval('"casbin_rule_id_seq"', 734, true);
...
SELECT setval('"jwt_blacklists_id_seq"', 7, true);
...
SELECT setval('"sys_api_tokens_id_seq"', 5, true);
...
SELECT setval('"sys_apis_id_seq"', 253, true);
...
SELECT setval('"sys_base_menu_btns_id_seq"', 8, true);
...
SELECT setval('"sys_base_menu_parameters_id_seq"', 2, true);
...
SELECT setval('"sys_base_menus_v2_id_seq"', 16, true);
...
SELECT setval('"sys_error_id_seq"', 108, true);
...
SELECT setval('"sys_login_logs_id_seq"', 20, true);
...
SELECT setval('"sys_operation_records_id_seq"', 493, true);
...
SELECT setval('"sys_timed_task_logs_id_seq"', 118, true);
